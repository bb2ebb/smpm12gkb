                            ...
                            <div class="col-sm-6 col-sm-offset-3 form-box">
                                <div class="form-top">
                                    <div class="form-top-left">
                                        ...
                                        <p>Masukkan nomor telepon atas nama <b><?php echo (isset($namasiswa) ? $namasiswa : "") ?></b>:</p>
                                    </div>
                                ...
                                <div class="form-bottom">
                                    <div class="form-group">
                                        ...
                                        <input name="notelp" placeholder="Nomor Telepon... contoh: 0313981234 <jgn diisikan nomor hp>" class="form-username form-control" id="form-notelp" type="text">
                                        <input name="exttelp" placeholder="ext / ekstension... contoh: 4268 <jgn diisikan apabila tidak ada>" class="form-username form-control" id="form-notelp" type="text">
                                    </div>
                                    <div class="form-group">
