                            ...
                            <div class="col-sm-6 col-sm-offset-3 form-box">
                                <div class="form-top">
                                    <div class="form-top-left">
                                        ...
                                        <p>Masukkan nomor HP Ibu atas nama <b><?php echo (isset($namasiswa) ? $namasiswa : "") ?></b>:</p>
                                    </div>
                                ...
                                <div class="form-bottom">
                                    <div class="form-group">
                                        ...
                                        <input name="hpibusiswa" placeholder="Nomor HP Ibu... contoh: 085740028612 <jgn diisikan nomor Telepon>" class="form-username form-control" id="form-notelp" type="text">

                                    </div>
                                    <div class="form-group">
                                        <button name="submithpibusiswa" type="submit" class="btn"><?php echo isset($_POST['submitteleponsiswa']) ? "Tambahkan Lagi!" : "Tambahkan" ?></button>
                                        <button name="selanjutnyahpibusiswa" type="submit" class="btn">Selanjutnya</button>
                                    </div>
                                </div>
                            </div>
                        </form>
