                        ...
                        foreach ($nohpayah as $value) {
                            echo '<div class="col-sm-6 col-sm-offset-3 form-box">
                                    <div class="form-bottom">
                                        ...
                                        <button onclick="post(\'edit\',{deletehpayahsiswa:\'\',id:\'' . $value->id . '\',idsiswa:\'' . (isset($idsiswa) ? $idsiswa : "") . '\',namasiswa:\'' . (isset($namasiswa) ? $namasiswa : "") . '\'})" class="btn">hapus</button>
                                    </div>
                                </div>';
                        }
                        ?>
